...
Feature: CMS.Upload Files
    ...
    # Uploading isn't working on safari with sauce labs
    @skip_safari
    Scenario: Users can properly upload files
        Given I am at the files and upload page of a Studio course
        When I click on button "Upload your first asset"
        Then I should "see" the upload modal
        Then I close upload modal by clicking close button
        And I should "not see" the upload modal
        When I upload the file "test" by clicking "Upload New File"
        And I should see the file "test" was uploaded
